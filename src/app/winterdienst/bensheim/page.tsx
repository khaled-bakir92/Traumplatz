...
const winterFaqs = [
  { question: `Ab wann räumen Sie bei Schneefall in ${city.name}?`, answer: `Da wir direkt in Bensheim ansässig sind, starten wir sofort bei Bedarf und priorisieren sichere Zugänge, Gehwege und Zufahrten.` },
  { question: `Übernehmen Sie Winterdienst auch in ${city.districts.slice(0, 2).join(" und ")}?`, answer: `Ja, wir betreuen Kunden im gesamten Stadtgebiet von ${city.name}, inklusive ${city.districts.join(", ")}. Bei der Einsatzplanung berücksichtigen wir Verkehrswege und frequentierte Flächen.` },
...
export default function BensheimWinterdienstPage() {
  return (
    <>
        ...
        <section className="py-24 bg-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mb-10 sm:mb-12">
              ...
              <p className="text-base sm:text-xl text-gray-500">{city.name} ist unser Hauptstandort – wir sind direkt vor Ort in {businessInfo.address.city}.</p>
            </div>
