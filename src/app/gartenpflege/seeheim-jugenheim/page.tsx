...
function getPageData() {
  ...
  const city = getCityBySlug("seeheim-jugenheim");
...
const gardenFaqs = [
  {
    ...
    answer:
      `Ja, wir übernehmen Einsätze im gesamten Gemeindegebiet von ${city.name} - inklusive ${city.districts.join(", ")}.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      `Da ${city.name} nur ${city.distanceFromHQ} km von unserem Standort entfernt liegt, sind Ersttermine häufig kurzfristig möglich.`,
  },
  {
...
export default function SeeheimJugenheimGartenpflegePage() {
  return (
    <>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mb-10 sm:mb-12">
              ...
              <p className="text-base sm:text-xl text-gray-500">
                {city.name} liegt nur {city.distanceFromHQ} km von unserem
                Standort in {businessInfo.address.city} entfernt.
              </p>
            </div>
