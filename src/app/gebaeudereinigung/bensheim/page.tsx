...
const cleaningFaqs = [
  ...
  { question: `Wie schnell kann eine Reinigung in ${city.name} starten?`, answer: `Da wir direkt in Bensheim ansässig sind, können wir Ersttermine kurzfristig und flexibel anbieten.` },
...
export default function BensheimGebaeudereinigungPage() {
  return (
    <>
        ...
        <section className="py-24 bg-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mb-10 sm:mb-12">
              ...
              <p className="text-base sm:text-xl text-gray-500">{city.name} ist unser Firmensitz – wir sind direkt vor Ort in {businessInfo.address.city}.</p>
            </div>
